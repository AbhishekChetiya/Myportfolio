                ...
                <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-10 md:mb-0">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Tilt options={{ max: 10, scale: 1.05, speed: 300 }}>
                                <a href="https://drive.google.com/file/d/1m2wGdQnI-JwGetPRf8P7s3x_lsSFV05m/view?usp=sharing" target="_blank" className="btn-secondary bg-blue-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">
                                    Resume
                                </a>
                            </Tilt>
                        </div>
